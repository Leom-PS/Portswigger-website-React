...
const SampleLandingPageEnt = (props) => {
  return (
    <div className="sample-landing-page-ent-container">
      <Helmet>
        <title>Sample-Landing-page-Ent - Portswigger website</title>
        <meta
          property="og:title"
          content="Sample-Landing-page-Ent - Portswigger website"
        />
      </Helmet>
      <div className="sample-landing-page-ent-container1">
        ...
        <div className="sample-landing-page-ent-container3">
          ...
          ></SecondaryButtonDark>
          <PrimaryButtonDark rootClassName="primary-button-dark-root-class-name5"></PrimaryButtonDark>
        </div>
        <img
          alt="image"
