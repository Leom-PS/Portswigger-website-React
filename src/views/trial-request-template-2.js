...
const TrialRequestTemplate2 = (props) => {
  return (
    <div className="trial-request-template2-container">
      <Helmet>
        <title>Trial-Request-template-2 - Portswigger website</title>
        <meta
          property="og:title"
          content="Trial-Request-template-2 - Portswigger website"
        />
      </Helmet>
      ...
      <div className="trial-request-template2-container3">
        ...
        <div className="trial-request-template2-container4">
          ...
          <PrimaryButtonDark rootClassName="primary-button-dark-root-class-name7"></PrimaryButtonDark>
        </div>
      </div>
    </div>
  )
